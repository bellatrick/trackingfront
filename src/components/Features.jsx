        ...
        <div className="space-y-12">
          <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
            ...
            <p className="text-xl text-gray-500">
              ...
              well as 30 years of experience, we will find the best solution for
              you. We make sure your cargo will get there: on time, safely, and
              on budget. Do not worry about the world becoming more and more
              complex and transportation requirements increasing every day. We
              will take care of it all, every step of the way.
            </p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className=" text-pink-600 leading-6  space-y-1">
                      <h3 className="font-bold text-xl mb-4">{person.title}</h3>
