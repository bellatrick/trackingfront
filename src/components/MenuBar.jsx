...
import { Dashboard, Add, Description, BookTwoTone } from "@material-ui/icons";
  ...
  return (
    <Transition.Root show={sidebarOpen} as={Fragment}>
      ...
      >
        ...
        >
          <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-rose-900">
            <Transition.Child
              as={Fragment}
            ...
            <div className="flex-shrink-0 flex items-center px-4">
              <img className="h-20 w-20" src="" alt="logo" />
            </div>
            <nav
              ...
              <div className="px-2 space-y-1">
                {navigation1.map((item) => (
                  <BaseNavLink
                    ...
                    className={({ isActive }) =>
                      [
                        "text-white hover:text-white hover:bg-rose-600 group flex items-center pl-8 px-2 py-4 text-lg  leading-6 font-medium rounded-md",
                ...
                <div className="px-2 cursor-pointer space-y-1">
                  {secondaryNavigation.map((item) => (
                    <div
                      ...
                      className="group flex items-center font-bold py-4 text-lg leading-6 pl-6 hover:bg-rose-600 tracking-wider rounded-md text-white "
                    >
                      <item.icon
